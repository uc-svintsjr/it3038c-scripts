...
**Rules:** The rules of the game are simple, once you start the script, it will open a window with you being a ball. Your objective is to see how many random size and spaced walls you're able to jump over using your spacebar. If you successfully jump over a wall that counts as one point. If you fail to jump over a wall and touch the wall, that results in a game over. <br>  
